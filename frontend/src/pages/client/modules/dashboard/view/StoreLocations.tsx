...
const initialLocations: Array<StoreLocation> = [
  {
    id: "1",
    name: "Downtown Shoes",
    address: "123 Main St",
...
export default function StoreLocations(): JSX.Element {
  const [locations, setLocations] =
    useState<Array<StoreLocation>>(initialLocations);
        ...
        <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
          ...
          <DialogContent>
            ...
            <div className="grid gap-4 py-4">
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                <Label className="text-right" htmlFor="manager">
                  Manager
                </Label>
                <Input
                  className="col-span-3"
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                <Label className="text-right" htmlFor="openingHours">
                  Opening Hours
                </Label>
                <Input
                  className="col-span-3"
