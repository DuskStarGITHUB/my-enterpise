...
const initialInventory: Array<InventoryItem> = [
  {
    id: "1",
    sku: "SN001",
    name: "Running Shoe",
...
export default function InventoryManagement():JSX.Element {
  const [inventory, setInventory] = useState<Array<InventoryItem>>(initialInventory);
          ...
          <DialogContent>
            ...
            <div className="grid gap-4 py-4">
              <div className="grid grid-cols-4 items-center gap-4">
                <Label className="text-right" htmlFor="sku">
                  SKU
                </Label>
                <Input
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                <Label className="text-right" htmlFor="reorderPoint">
                  Reorder Point
                </Label>
                <Input
                  className="col-span-3"
